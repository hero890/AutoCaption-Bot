...
try: app_id = int(os.environ.get("app_id", "22672907"))
except Exception as app_id: print(f"⚠️ App ID Invalid {app_id}")
try: api_hash = os.environ.get("api_hash", "0ff15ae2153bd8e03b48cb293010bc6a")
except Exception as api_id: print(f"⚠️ Api Hash Invalid {api_hash}")
try: bot_token = os.environ.get("bot_token", "7011168472:AAF60kVcPAQ1OQErZmCMyqofufS9UO52UCs")
